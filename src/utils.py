...
PAGES = {
    ...
    "dashboard":   {"path": "pages/1_Dashboard.py",      "label": "Dashboard",     "icon": "📊"},
    "predictions": {"path": "pages/2_Predictions.py",    "label": "Predictions",   "icon": "🔮"},
    "explorer":    {"path": "pages/3_Data_Explorer.py",  "label": "Data Explorer", "icon": "📁"},
    "about":       {"path": "pages/4_About.py",          "label": "About",         "icon": "ℹ️"},
}
